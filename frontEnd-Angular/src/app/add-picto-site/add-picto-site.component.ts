...
@Component({
  selector: 'app-add-picto-site',
  templateUrl: './add-picto-site.component.html',
  styleUrl: './add-picto-site.component.css'
})

export class AddPictoSiteComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<AddPictoSiteComponent>, private snackBar: MatSnackBar,private ser:PlanningServiceService){}
